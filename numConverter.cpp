...
bool numConverter::convert(string subCommand) {
  if (numConverter::type == "0d") {
    if (subCommand == "d2b") {
      numConverter::num = convertD2B(num);
      numConverter::type = "0b";
      return true;
    } else if (subCommand == "d2h") {
      numConverter::num = convertB2H(convertD2B(num));
      numConverter::type = "0x";
      return true;
    }
  }
  ...
  if (numConverter::type == "0b") {
    if (subCommand == "b2h") {
      ...
      numConverter::type = "0x";
      return true;
    } else if (subCommand == "b2d") {
      numConverter::num = convertB2D(num);
      numConverter::type = "0d";
      return true;
    }
  }

  if (numConverter::type == "0x") {
    if (subCommand == "h2b") {
      numConverter::num = convertH2B(num);
      numConverter::type = "0b";
      return true;
    } else if (subCommand == "h2d") {
...
bool numConverter::convertManual(string newType) {
